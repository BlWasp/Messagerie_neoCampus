...
public class Test_Groupe1 {
    public static void main(String[] args) {
        ...
        Groupe l3info = new GroupeNomme("L3 infoG1");
        Groupe l3info2 = new GroupeNomme("L3 infoG2");
        Groupe groupedediscussion = new Groupe();

        Groupe secretaria = new GroupeNomme("Secrétaria");
        secretaria.ajouterMembres(nadege);


        l3info.ajouterMembres(salim,guillaume);
        l3info2.ajouterMembres(sylvain,salim);

        groupedediscussion.ajouterMembres(l3info,l3info2,secretaria);
        l3info.ajouterMembres(groupedediscussion);

        System.out.println(groupedediscussion._listeUtisateurToString());
    }
}
